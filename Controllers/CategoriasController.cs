...
namespace Sistema_Patrimonio.Controllers
{
    public class CategoriasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("idcategoria,descricaocategoria")] DbCategoria dbCategoria)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("idcategoria,descricaocategoria")] DbCategoria dbCategoria)
        {
            if (id != dbCategoria.idcategoria)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!DbCategoriaExists(dbCategoria.idcategoria))
                    {
                        return NotFound();
                    }
                    else
